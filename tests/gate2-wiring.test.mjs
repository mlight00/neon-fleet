...
test('G2-15: Codex 홀리스틱 4건 — 등급 스케줄 격리·play 행동·미배선 사건·HUD 타이머', () => {
  ...
  assert.ok(/function campaignBehavior[\s\S]{0,320}if \(steps\.length\) steps\[0\]\.apply\(\)/.test(mainSrc) && /function campaignBehavior[\s\S]{0,420}cl\.metrics\.choice/.test(mainSrc), '#2: 행동 변화 두 모드 적용');
