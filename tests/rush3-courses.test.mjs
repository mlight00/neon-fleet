...
//   r3.29(2026-09-23 이사 지시 '10번을 보스 분기점으로'): 광장이 10·11 → 15·20 으로, 복수 정예가 9 → 10 으로 옮겨 가며
//   내용이 바뀐 9·10·11·15·20 은 +1(기록 칸 분리 — 옛 기록은 옛 버전 칸에 남는다)
const REPLACED = { 6: 3, 7: 3, 8: 3, 9: 4, 10: 3, 11: 3, 12: 3, 15: 4, 20: 4, 23: 3, 24: 3 };
...
test('V3-COURSE C-2: 길이·정예·배경 — 길이 30~60초(z 5700~11400)·eliteZ = elite.z < length·bg 1~5(C-3 표)', () => {
  //  r3.29 로 10 ↔ 15 · 11 ↔ 20 의 코스가 통째로 자리를 바꿨다(배경도 함께 간다)
  const BG = { 4: 1, 5: 2, 6: 4, 7: 3, 8: 1, 9: 2, 10: 4, 11: 5, 12: 5, 13: 4, 14: 4, 15: 4, 16: 4, 17: 4, 18: 4, 19: 5, 20: 4, 21: 5, 22: 5, 23: 5, 24: 5 };
  for (const id of NEW) {
