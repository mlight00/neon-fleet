...
test('V3-PURE: combat/gates/supply/squad/weapons/advice/bonus/motion/firepower 소스에 Math.random·rng import 가 없다(stages.js 는 rng 허용)', () => {
  for (const f of ['combat.js', 'gates.js', 'supply.js', 'squad.js', 'weapons.js', 'advice.js', 'bonus.js', 'motion.js', 'firepower.js']) {
    const code = read(f);
