...
async function bootFake(storage = fakeStorage()) {
  ...
  //  r4.3 순차 해금: 빈 저장은 1번만 열린다 — 이 하네스는 '옛 저장에 1~7번 클리어 기록이 있는 사용자'로 시작한다(검사하는 판 8 은 비워 둔다 — 그 판의 옛 칸 단언 보존)(옛 버전 칸 — 화면·코인 무영향, tests/lib/rush3-unlock.mjs)
  seedOldClears(save, 7);
