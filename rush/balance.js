...
export const BAL = {
  ...
  track: { length: 57000, zoneLen: 11400, zones: 5, scrollSpeed: 190, gateEvery: 520, firstGateZ: 300, waveEvery: 260 },   // 구간당 60초(스크롤), 성장은 게이트가·웨이브는 양념
  ...
  gates: {
    ...
    // 진행도 t(0..1)에 따른 값 범위
    addMin: 6, addMax: 50, mulVals: [2, 3], subMin: 5, subMax: 60, divVals: [2, 3],
    width: 150, gap: 20, h: 64,   // 총폭 320(80~400) = 도로·이동 범위와 일치
  },
  enemies: {
    //  구간1
    scrapbit:      { hp: 2,  r: 12, speed: 120, count: [3, 7],  coin: 1 },
    wheeler:       { hp: 3,  r: 13, speed: 170, count: [2, 3],  coin: 2, zigzag: 140 },
    //  구간2
