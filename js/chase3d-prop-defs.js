...
export const NOZZLE_POINTS = [
  //  §G-46 3차(이사 실기 캡처): EMBER 는 분사구가 **2개**다. 1개로 두면 가운데에서 하나만 뿜는다.
  [[-0.176, 0.353, 0.176], [0.176, 0.353, 0.176]],                                                      // t0 scout — 좌우 2구 (2D x=±6 ÷ w34)
  [[-0.100, 0.350, 0.150], [0.100, 0.350, 0.150]],                                                      // t1 interceptor
  [[-0.154, 0.397, 0.128], [0.154, 0.397, 0.128]],                                                      // t2 striker
  [[-0.221, 0.423, 0.087], [-0.077, 0.423, 0.087], [0.077, 0.423, 0.087], [0.221, 0.423, 0.087]],       // t3 carrier
  [[-0.394, 0.418, 0.091], [-0.197, 0.455, 0.100], [0, 0.473, 0.109], [0.197, 0.455, 0.100], [0.394, 0.418, 0.091]],   // t4 dreadnought
  [[-0.250, 0.442, 0.070], [0, 0.477, 0.081], [0.250, 0.442, 0.070]],                                   // t5 titan
];
