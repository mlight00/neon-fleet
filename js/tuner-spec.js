...
const ENEMY_GLOBAL = {
  ...
  items: [
    ...
    { ns: 'bal', path: 'economy.weaponHpWeight', name: '무기 강화 → 적 체력 추종', desc: '0=옛 동작(무기 키우면 적 압도), 1=완전 추종', min: 0, max: 1.5, step: 0.05 },
    { ns: 'bal', path: 'weaponEvolution.evoEffectiveMult', name: '무기 1차 진화 시 적 체력 배수', desc: '진화의 관통·분열·다탄 실효 화력 보정', min: 1, max: 3, step: 0.05 },
    { ns: 'bal', path: 'weaponEvolution.superEffectiveMult', name: '무기 초진화 시 적 체력 배수', desc: '진화 위에 추가', min: 1, max: 3, step: 0.05 },
