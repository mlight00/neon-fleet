...
export const GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { ns: 'sprite', path: 'B9', name: '보스 크기 · 볼텍스 마우', min: 80, max: 600, step: 10 },
      { ns: 'sprite', path: 'B10', name: '보스 크기 · 옵시디언 클로', min: 80, max: 600, step: 10 },
      { ns: 'sprite', path: 'B11', name: '보스 크기 · 보이드 세라프', min: 80, max: 600, step: 10 },
      { ns: 'sprite', path: 'B12', name: '보스 크기 · 프리즘 타이런트', min: 80, max: 600, step: 10 },
      { ns: 'sprite', path: 'B13', name: '보스 크기 · 타이달 리바이어던', min: 80, max: 600, step: 10 },
      { ns: 'sprite', path: 'B14', name: '보스 크기 · 스톰브링어', min: 80, max: 600, step: 10 },
      { ns: 'sprite', path: 'B15', name: '보스 크기 · 옵틱 워든', min: 80, max: 600, step: 10 },
