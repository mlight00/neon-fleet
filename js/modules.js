...
export const MODULE_DEFS = [
  ...
  { id: 'pierce', name: '관통탄',      icon: '🎯', desc: '탄이 적을 1기 더 관통',   rarity: 'common', max: 3, apply: (m) => { m.pierceBonus += 1; } },
  { id: 'explode',name: '폭발 탄두',   icon: '💥', desc: '적 파괴 시 주변 약한 폭발', rarity: 'common', max: 3, apply: (m) => { m.explodeRadius += 20; m.explodeDmgFrac += 0.015; } },
  ...
  { id: 'swarm',  name: '군체 의지',   icon: '🐝', desc: '드론 1기당 화력 +0.12',   rarity: 'rare',   max: 5, apply: (m) => { m.swarmPerDrone += 0.12; } },
  // 차지 랜스 특화
  { id: 'chgPower', name: '충전 증폭', icon: '🔆', desc: '차지 랜스 위력 +12%',      rarity: 'common', max: 4, apply: (m) => { m.chargeMult *= 1.12; } },
