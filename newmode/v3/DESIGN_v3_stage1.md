...
|---|---|---|---|---|---|
| grunt | 2 | 14 | 60 | x를 `run.x` 쪽으로 90px/s 추종(사선에 들어와 쓸린다) | 유닛 hp −1, 적 소모 |
...
| 3040 | 16.0s | 게이트 행: 좌 `[80,240)` −6, `bypass`(우는 빈 길). maxValue 15 |
...
| 7200 | 37.9s | 정예 hp 40 (부채꼴 3발, 소환 없음) |
| length 7600 | | |

### S2 「갈림길」 (시작 2명·rifle, 정예 z 8200)
| z | 도달 | 내용 |
|---|---|---|
| 1140 | 6.0s | 게이트 행: 좌 `[80,240)` −8 / 우 `[240,400)` −3 (완전 피복, 둘 다 음수). maxValue 20 |
| 1800~3000 | | **분리벽** x 228~252 |
| 2300 | 12.1s | 좌 병사 통 x 154 내구 6 병사 3 / 우 무기 통 x 326 auto 내구 12 |
| 3600 | 18.9s | grunt 5 + rusher 2 (xs 110/370) |
| 4600 | 24.2s | shooter 2 (x 150, 330; 도로 고정) |
| 5400 | 28.4s | 게이트 행: 좌 +2 / 우 −10 (완전 피복) |
| 5800 | 30.5s | 병사 통 x 330 내구 15 병사 5 (−10 뒤의 보상) |
| 7000 | 36.8s | grunt 8 |
| 8200 | 43.2s | 정예 hp 70 |
| length 8600 | | |
...
| z | 도달 | 내용 |
|---|---|---|
| 1100 / 1500 / 1900 | 5.8/7.9/10.0s | 병사 통 x 240 내구 4·5·6, 병사 2·2·3 |
| 2800 | 14.7s | **연속 증원 컨테이너** x 240 내구 10, 발판 5, 최대 15 |
| 4000 | 21.1s | 게이트 행: 좌 +3 / 우 −12 (완전 피복). maxValue 40 |
| 4400 | 23.2s | 무기 통 heavy x 330 내구 24 (−12 뒤의 보상) |
| 5200 | 27.4s | grunt 10 (2열) |
| 6000~7200 | | **분리벽** x 228~252 |
| 6300 | 33.2s | 좌 shooter 2 (x 120, 190) / 우 병사 통 x 326 내구 12 병사 6 |
| 8000 | 42.1s | rusher 4 (xs 100/190/290/380) |
| 8800 | 46.3s | grunt 12 + shooter 2 (x 130, 350) |
| 10600 | 55.8s | 정예 hp 150, 4s마다 grunt 2 소환 |
| length 11000 | | |
